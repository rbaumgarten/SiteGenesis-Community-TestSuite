...
/**
 * <p>Test adding a standard product to the cart from quickview and product detail pages.</p>
 ...
 */
@ScriptName
("tests.cart.TCart_Add_ProductSet")
public class TCart_Add_ProductSet extends AbstractScriptTestCase
{
}