...
/**
 * <p>Verifies the structure of quickview (QV) and product details pages (PDP) for  product sets</p>
 ...
 */
@ScriptName
("tests.product.TProduct_Validate_ProductSet")
public class TProduct_Validate_ProductSet extends AbstractScriptTestCase
{
}