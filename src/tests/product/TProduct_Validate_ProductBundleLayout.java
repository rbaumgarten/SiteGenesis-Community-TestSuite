...
/**
 * <p>Verifies the structure/layout of quickview (QV) and product details pages (PDP) for product bundles</p>
 ...
 */
@ScriptName
("tests.product.TProduct_Validate_ProductBundleLayout")
public class TProduct_Validate_ProductBundleLayout extends AbstractScriptTestCase
{
}